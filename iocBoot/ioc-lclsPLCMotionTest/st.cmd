...
#
#   LCLS General: * (SLAC)
#   lcls-twincat-motion: * -> 4.3.0 (SLAC)
...
#   lcls-twincat-motion: * -> 4.3.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lclsPLCMotionTest,DEPENDENCY=lcls-twincat-motion,VERSION=4.3.0,VENDOR=SLAC")
#   Tc2_Standard: * -> 3.4.5.0 (Beckhoff Automation GmbH)
