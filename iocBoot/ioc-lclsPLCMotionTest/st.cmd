...
#
#   LCLS General: * (SLAC)
#   lcls-twincat-motion: * -> 2.2.4 (SLAC)
...
#   lcls-twincat-motion: * -> 2.2.4 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lclsPLCMotionTest,DEPENDENCY=lcls-twincat-motion,VERSION=2.2.4,VENDOR=SLAC")
#   Tc2_Standard: * -> 3.4.5.0 (Beckhoff Automation GmbH)
