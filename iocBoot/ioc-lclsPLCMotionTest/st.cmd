#!c:/Repos/ads-ioc/R2.0.0///bin/windows-x64/adsIoc
...
#
#   LCLS General: * (SLAC)
#   lcls-twincat-motion: * -> 4.4.0 (SLAC)
#   PMPS: * (SLAC - LCLS)
...
epicsEnvSet("ADS_MAX_PARAMS",   "1301")
...
epicsEnvSet("MOTOR_ADS_PATH",  "PMPS.M1")
epicsEnvSet("DESC",            "PMPS.M1 / Axis_PMPS_M1")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("MOTOR_ADS_PATH",  "PMPS.M2")
epicsEnvSet("DESC",            "PMPS.M2 / Axis_PMPS_M2")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_ADS_PATH",  "PMPS.M3")
epicsEnvSet("DESC",            "PMPS.M3 / Axis_PMPS_M3")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:lclsPLCMotionTest,PROJECT=lcls-motion-test.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.20.0,PLC_HOST=172.21.148.154")

#   LCLS General: * (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lclsPLCMotionTest,DEPENDENCY=LCLS_General,VERSION=*,VENDOR=SLAC")
#   lcls-twincat-motion: * -> 4.4.0 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lclsPLCMotionTest,DEPENDENCY=lcls-twincat-motion,VERSION=4.4.0,VENDOR=SLAC")
#   PMPS: * (SLAC - LCLS)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:lclsPLCMotionTest,DEPENDENCY=PMPS,VERSION=*,VENDOR=SLAC - LCLS")
#   Tc2_Standard: * -> 3.4.5.0 (Beckhoff Automation GmbH)
